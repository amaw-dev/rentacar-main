...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    gscClientSecret: '',
    gscRedirectUri: '',
    // Firebase credentials (server-only for blog API)
    firebaseProjectId: '',
    firebaseClientEmail: '',
    firebasePrivateKey: '',
  ...
  nitro: {
    preset: "firebase",
    firebase: {
      serverFunctionName: "rentacar_main_alquicarros",
      gen: 2,
      nodeVersion: "20",
      httpsOptions: {
        maxInstances: 1,
